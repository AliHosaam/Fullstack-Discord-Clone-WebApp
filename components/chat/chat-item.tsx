...
const ChatItem: React.FC<ChatItemProps> = ({
  ...
  const canEditMessage = !deleted && isAdmin && !fileUrl;
          ...
          {canEditMessage && (
            <ActionTooltip label="Edit">
              <Edit
                ...
                className="ml-auto cursor-pointer w-4 h-4 text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-300 transition"
              />
            </ActionTooltip>
          )}
